        ...
        <Grid container style={{ maxWidth: '65% ', margin: 'auto' }}>
          ...
          <Grid item xs={6}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', wordSpacing: 'normal' }}>
              ...
              <p
                onClick={() => props.history.push('/specialties/' + data.specialty_id)}
                style={{ color: 'blue', cursor: 'pointer' }}
              >
            ...
            <p>
              <strong>Rating: </strong> {format.rating(data)}
            </p>
          </Grid>
          <Grid item xs={6}>
            <h2>Location</h2>
          ...
          <iframe title="docmap" style={{ width: '100%', height: '20em' }} src={url} />
